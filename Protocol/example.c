...
int main()
{
    ...
    /* Note: h_out.nonce will be all zeros since uavlink_pack_with_nonce copies header and generates nonce internally */
    printf("Nonce generated by uavlink_pack_with_nonce (check bytes 12-19 of packet)\\n");

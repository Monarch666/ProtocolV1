#!/usr/bin/env python3
"""
Kestrel 30-Minute Internal Integration Test
...
REPORT   = os.path.join(os.path.dirname(__file__), "test_30min_report.txt")
...
def write_report(elapsed):
    ...
    report_lines = [
        "=" * 65,
        "  Kestrel 30-Minute Internal Integration Test Report",
...
def main():
    print("=" * 65)
    print("  Kestrel 30-Minute Internal Integration Test")

/*
 * Kestrel Phase 3 Advanced Optimizations
 *
 * Features:
...
#ifndef KESTREL_COMPRESS_H
#define KESTREL_COMPRESS_H
...
typedef struct
{
    ...
    ks_heartbeat_t prev_heartbeat;
    ks_attitude_t prev_attitude;
    ks_gps_raw_t prev_gps;
    ks_battery_t prev_battery;
    ks_rc_input_t prev_rc;

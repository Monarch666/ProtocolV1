/*
 * Kestrel Hardware Crypto Acceleration
 *
...
#ifndef KESTREL_HW_CRYPTO_H
#define KESTREL_HW_CRYPTO_H
...
#define KS_HW_NEON_AVAILABLE 1
#include <arm_neon.h>
#else
#define KS_HW_NEON_AVAILABLE 0
#endif
...
#define KS_HW_SSE2_AVAILABLE 1
#include <emmintrin.h> // SSE2
#else
#define KS_HW_SSE2_AVAILABLE 0
#endif

#if defined(__AVX2__)
#define KS_HW_AVX2_AVAILABLE 1
#include <immintrin.h> // AVX2
#else
#define KS_HW_AVX2_AVAILABLE 0
#endif
